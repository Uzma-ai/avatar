    ...
    <div className="flex h-full bg-white">
      ...
      <div className="flex-1 h-full px-6 overflow-hidden">
        ...
        <div className="bg-gray-100 p-4 h-[calc(100vh-112px)] overflow-y-auto scroll">
          <div className="bg-white rounded-lg shadow-md px-4 max-w-6xl mx-auto">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    >
                      <div className="p-4 bg-white border border-lightblue rounded-md">
                  ...
                  <div>
                    ...
                    <RadioGroup
                      ...
                      onValueChange={setSelectedMethod}
                    >
                      <div className="p-4 border-b-2 bg-white border border-lightblue rounded-md">
                        <div className="flex items-center gap-3">
