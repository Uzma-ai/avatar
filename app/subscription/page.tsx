        ...
        <div className="bg-gray-100 p-4 h-[calc(100vh-112px)] overflow-y-auto scroll">
          <div className="bg-white rounded-lg shadow-md p-8 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between lg:items-start mb-4 gap-2">
              ...
              <div className={`w-full lg:w-1/2 border border-secondarycolor p-4 rounded-lg ${isPremiumSelected ? "mr-4" : ""}`} onClick={handlePremiumClick}>
              ...
              {isPremiumSelected && (
                <div className="w-full lg:w-1/2 flex flex-col">
                  <div className="flex items-start">
                    <h2 className="text-xl font-semibold text-black mt-4 text-left">You&apos;re a Premium Member!</h2>
                  </div>
                  <div>
                    <p className="text-gray-600 mt-2">Thank you for being part of our premium family!</p>
                  </div>
                  <div className="w-full border-t-2 border-secondarycolor mt-3"></div>
                  <h3 className="text-lg font-semibold mt-4 text-black">Subscription Details</h3>
                  <div className="flex justify-between w-full px-3">
                    <h3 className="text-base font-medium mt-4 text-black">Current Plan</h3>
                    <h3 className="text-base font-medium mt-4 text-gray-500">Premium</h3>
                  </div>
                  <div className="flex justify-between w-full px-3">
                    <h3 className="text-base font-medium mt-4 text-black">Next billing date</h3>
                    <h3 className="text-base font-medium mt-4 text-gray-500">23rd Nov 2026</h3>
                  </div>
                  <div className="flex justify-between w-full px-3">
                    <h3 className="text-base font-medium mt-4 text-black">Payment Method</h3>
                  ...
                  <div className="flex justify-between w-full mt-4 px-3">
                    <a href="#" className="text-sm font-medium text-secondarycolor mt-40 underline">See Past Invoices</a>
                    <a href="#" className="text-sm font-medium text-secondarycolor mt-40 underline">Update Payment Method</a>
                  </div>
                  
                
                  <div className="flex justify-between gap-4 w-full mt-4">
                    <button className="px-6 py-2 bg-white border border-secondarycolor text-secondarycolor rounded-md">Cancel Subscription</button>
                    <button className="px-14 py-2 bg-secondarycolor text-white rounded-md">Change Plan</button>
                  </div>
                </div>
              )}
            </div>
